...
const DetailProduct = () => {
  ...
  useEffect(() => {
    ...
    if (size === "medium")
      setPrize(quantity * (initPrice + product?.product.upsize[0] / 1000 + handleGetToppingPrice(toppings)));
    if (size === "large")
      setPrize(quantity * (initPrice + product?.product.upsize[1] / 1000 + handleGetToppingPrice(toppings)));
  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-[100%] flex flex-col gap-3 md:flex-row justify-between">
          ...
          <div className="w-[100%] md:w-[50%] mt-10 md:mt-0">
            ...
            <div className="flex flex-col gap-3 mt-8">
              ...
              <div className="flex flex-wrap gap-5">
                ...
                >
                  ...
                  <p className="text-sm">Vừa + {product?.product.upsize[0]} đ</p>
                </div>
                <div
                ...
                >
                  ...
                  <p className="text-sm">Lớn + {product?.product.upsize[1]} đ</p>
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-3 mt-10">
              ...
              <div className="flex flex-wrap gap-5">
                {product?.toppingList && product.toppingList.map((topping: any,) => {
                  return (
                    <ToppingComponent topping={topping} isActive={toppings.includes(topping.toppingId)} handleAddTopping={handleAddTopping} />
                  )
                })}
              </div>
            </div>
