        ...
        <div className="w-[100%] md:w-[50%] mt-10 md:mt-0">
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <div className="flex flex-wrap gap-5">
              ...
              >
                ...
                <p className="text-sm">Vừa + 6.000 đ</p>
              </div>
              <div
                className={`py-2 px-5 flex items-center gap-3 rounded-md border hover:cursor-pointer ${
                  size === "large"
              ...
              >
                ...
                <p className="text-sm">Lớn + 10.000 đ</p>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-3 mt-8 mb-8">
            ...
            <div className="flex flex-wrap gap-5">
              ...
              >
                <p className="text-sm">Kem Phô Mai Macchiato + 10.000 đ</p>
              </div>
              <div
                className={`py-2 px-5 flex items-center gap-3 rounded-md border hover:cursor-pointer ${
                  toppings.includes(2)
              ...
              >
                <p className="text-sm">Shot Espresso + 10.000 đ</p>
              </div>
              <div
                className={`py-2 px-5 flex items-center gap-3 rounded-md border hover:cursor-pointer ${
                  toppings.includes(3)
          ...
          <Link to="/order">
            <div className="flex gap-3 justify-center items-center text-white font-semibold p-3 rounded-md bg-[#e57905]">
              <svg
                width="21"
                height="21"
                viewBox="0 0 21 21"
