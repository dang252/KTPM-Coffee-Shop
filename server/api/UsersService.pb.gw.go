...
func request_UsersService_Greeting_0(ctx context.Context, marshaler runtime.Marshaler, client UsersServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_UsersService_Greeting_0(ctx context.Context, marshaler runtime.Marshaler, server UsersServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq EmptyRequest
	var metadata runtime.ServerMetadata
...
func RegisterUsersServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UsersServiceServer) error {
	...
	mux.Handle("GET", pattern_UsersService_Greeting_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_UsersService_Greeting_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_UsersService_Greeting_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterUsersServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UsersServiceClient) error {
	...
	mux.Handle("GET", pattern_UsersService_Greeting_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_UsersService_Greeting_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_UsersService_Greeting_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"Users"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_UsersService_Greeting_0 = runtime.ForwardResponseMessage
)
